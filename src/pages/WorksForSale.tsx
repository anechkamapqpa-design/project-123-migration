...
export default function WorksForSale() {
      ...
      >
        {saleWorks.map((work, i) => (
          ...
          >
            ...
            <div className="mt-2" style={{ color: 'hsl(var(--gallery-text-faint))' }}>
              <p className="m-0" style={{ fontSize: 'clamp(0.5rem, 0.8vw, 0.7rem)', letterSpacing: '0.15em' }}>
                {work.size}
              </p>
              <p className="m-0 mt-1" style={{ fontSize: 'clamp(0.5rem, 0.8vw, 0.7rem)', letterSpacing: '0.15em', color: 'hsl(var(--gallery-text-dim))' }}>
                {work.price}
              </p>
            </div>
          </motion.div>
